...
pygame.display.set_caption("飞机大战  --Adam Chen")
...
def main():
    ...
    text_font = pygame.font.Font("font/font.ttf",36)
    ...
    while running:
        ...
        # 绘制暂停文字
        if paused:
            pause_text = text_font.render("Click the button to continue", True, BLACK)
            screen.blit(pause_text, (40, 340))
